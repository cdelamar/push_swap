...
# define NUM_FAILURE			"invalid argument : non-numbers included \n"
# define ARGC_FAILURE    		"incorrect argument input : too many or no argument\n"
# define DOUBLON_FAILURE		"invalid argument : at least one number appear twice\n"
